...
module.exports = {
	...
	async landingPage(req, res, next) {
		res.render('index', {title: 'Location - Home'});
	},

	// GET /register
	getRegister(req, res, next){
		res.render('register', {tilte: 'Location - Register', username: '', email: ''})
	},
	...
	async postRegister(req, res, next) {
		try {
			...
			req.login(user, function(err){
				...
				req.session.success =  `Welcome to Location, ${user.username}!`;
				res.redirect('/');
			});
			...
			res.render('register', { title: 'Location - Register', username,email,error});
		}
	},
